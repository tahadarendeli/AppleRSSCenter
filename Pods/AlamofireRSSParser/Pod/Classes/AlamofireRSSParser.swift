    ...
    */
    ...
    open func parser(_ parser: XMLParser, didEndElement elementName: String, namespaceURI: String?, qualifiedName qName: String?) {
        ...
        if let currentItem = self.currentItem {
            ...
            if (elementName == "id") {
                currentItem.id = self.currentString
            }
            ...
            if (elementName == "im:name") {
                currentItem.name = self.currentString
            }

            
            if (elementName == "summary") {
                currentItem.summary = self.currentString
            }
        ...
        //if we're at the top level
            ...
            if (elementName == "content") {
                self.feed?.content = self.currentString
            }
            
            if (elementName == "name") {
                self.feed?.name = self.currentString
            }
            
            if (elementName == "id") {
                self.feed?.id = self.currentString
            }
            ...
            if (elementName == "summary") {
                self.feed?.summary = self.currentString
            }
